...
# MD2WX Studio 在线使用：GitHub Pages 自动化部署、自定义域名与微信排版黑科技实战
...
今天，我再次敲开终端与 AI 结对编程，一口气完成了 **生产环境上线** 与 **多项微信排版核心黑科技攻坚**。

不仅部署了独立域名 **[https://md2wx.zaneven.com](https://md2wx.zaneven.com)**，更把整个排版体验推向了全新高度。
...
![Cloudflare 与 GitHub Pages 现代化自动化部署流水线全景](assets/cloud-deploy-pipeline.png)
*▲ 图：从本地代码推送、GitHub Actions 自动化编译，到 Cloudflare 边缘 DNS 解析与独立域名全球发布的完整流水线架构*
...
![微信排版黑科技实机效果](assets/md2wx-footnotes-card.png)
*▲ 图：iPhone 仿真视口实拍：正文链接智能上标、Mac 三色圆点内联彩色代码高亮，以及文末结构化参考资料引用卡片*
...
![排版微调设置面板特写](assets/md2wx-settings-panel.png)
*▲ 图：全新排版微调面板：多档字号与行距滑块、外链转脚注开关与双栏同步滚动联动控制*
